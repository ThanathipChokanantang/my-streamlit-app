            ...
            if event_type_th and location_th:
                ...
                if json_output:
                    ...
                    try:
                        ...
                        df['เหตุการณ์_Label'] = df['วันที่_หรือ_ช่วงเวลา'] + ' (' + df['ลำดับ_ชั่วคราว'].astype(str) + ')'
                        ...
                        fig1 = px.bar(
                            ...
                            labels={'มูลค่า_ความเสียหาย_บาท': 'มูลค่าความเสียหาย (บาท)', 'เหตุการณ์_Label': 'วันที่/ช่วงเวลาเหตุการณ์ (เรียงตามลำดับ)'},
                            height=400,
